...
const setup_pass = document.getElementById('pass');
  ...
  function submitAdmission() {
    toast('Enrollment form submitted successfully! We will review your application and contact you soon.', 'success');
    setTimeout(() => window.location.href = 'setup_password.php', 2500);
